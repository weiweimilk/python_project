...
class Node:
    ...
    def query(self, query, history=[]):
        """
          query file, may need the adjacent node's help, 
    ...
    def fetch(self, query, secret):
        """
          to let node find file and download
        """
    ...
    def _handle(self, query):
        """
          internal function: to handle query
        """
        dir = self.dirname
        name = join(dir, query)
    ...
    def _broadcast(self, query, history):
        """
          internal function: to broadcast the query to all known nodes
        """
